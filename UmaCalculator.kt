...
class UmaCalculator {
    ...
    fun calculateVA() {
        ...
        v3 = (tactSpeed3[tact]!! + (aWisdom * log10(aWisdom / 10.0)) / 550000.0 - 0.00325) * v0 + sqrt(aSpeed * 500) * distanceSpeed * 0.002
        v4 = ((tactSpeed3[tact]!! + 0.01) * v0 + sqrt(aSpeed * 500) * distanceSpeed * 0.002) * 1.05 + sqrt(aSpeed * 500) * distanceSpeed * 0.002
